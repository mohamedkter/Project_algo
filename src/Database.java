...
public class Database {
    ...
    skip<String, Object> skipList = new skip<>();
    /**
...
//        list = new SkipList<String, Rectangle>();
     ...
     */
    public void insert(KVPair<String, Object> pair) {
...
skipList.remove(name);
     ...
     */
    public void removebyvalue(Object rectangle) {
skipList.removeByValue(rectangle);
    }
